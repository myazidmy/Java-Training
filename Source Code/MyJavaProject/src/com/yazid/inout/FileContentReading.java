...
// Here we will accept a directory name from the keyboard and then display all 
// the contents of the directory .For this purpose, list() method can be used as:

// String arr[]=f.list();
// In the preceding statement , the list() method causes all the directory entries 
// copied into the array arr[]. Then pass these array elements arr[i] to File object 
// and test them to know if they represent a file or directory .
