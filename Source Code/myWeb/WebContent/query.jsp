...
<body>
  ...
  <form method="get">
    ...
    <input type="checkbox" name="author" value="Mohammadd Ali">Ali
  ...
  <%
	    ...
	    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/ebookshop", "myuser", "coolgopi"); // <== Check!
      // Connection conn =
